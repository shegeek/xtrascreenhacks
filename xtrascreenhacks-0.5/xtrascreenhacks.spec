...
URL:		http://home.comcast.net/~shegeek/software/xtrascreenhacks
Source0:	http://home.comcast.net/~shegeek/software/xtrascreenhacks/xtrascreenhacks-%{version}.tar.gz
Vendor:		Kelley Nielsen <shegeek-dev@comcast.net>
...
Provides: xtrascreenhacks
Obsoletes: xtrascreenhacks
...
%description
This package contains additional display modes to be used 
with XScreenSaver or other daemon.
