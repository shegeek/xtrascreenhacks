...
# endif
...

  {
    ...
    *s2 = 0;
    *s4 = 0;
    /* changed to reflect use and redistribution by shegeek */
/*     sprintf (version, "%s: from the XScreenSaver %s distribution (%s.)", */
/* 	     progclass, s1, s3); */
    sprintf (version, "%s: from the XtraScreenHacks %s collection (%s.)",
	     progclass, s1, s3);
    free(v);
  }
...
/*       fprintf (stderr, "  http://www.jwz.org/xscreensaver/\n\n"); */
      fprintf (stderr, "  http://home.comcast.net/~shegeek/xtrascreenhacks/\n\n");
